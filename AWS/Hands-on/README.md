...
4. Create EC2 in VPC of  "amazon-vpc-a" named "Local"

```bash 
Region: "N.Virginia"
VPC: 'amazon-vpc-a'-public 
Subnet: PublicA
...
```
5. Create "Windows" instance in VPC of  "amazon-vpc-a" named "Windows"
...
Location               :
  - Countries Singapore
Health check            : Keep it as is
Record ID               : Geolocation Scenario-Singapore
```
...
```bash
   Domain name: the same name of your domain(for example: cloudengineer.us)
   Description: ---
...
- type "www.<your-domain-name>". show which content is seen "local instance content" in VPC 
- go to the public browser than type browser: "www.<your-domain-name>" than show that, N.Virginia instance is seen on public internet.
